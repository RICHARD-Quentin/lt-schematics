...
describe('<%= classify(name) %>Controller', () => {
  ...
  describe('search', () => {
    it('should return an array of <%= classify(name) %> objects and the total count', async () => {
      const req = getMockReq()
      const query = { _id: _id.toString() }
      const limit = 10
      const skip = 1
      const expectedResult: [<%= classify(name) %>[], number] = [[object], 1]
    ...
    it('should return an array of <%= classify(name) %> objects with default pagination', async () => {
      const req = getMockReq()
      const query = { _id: _id.toString() }
      const limit = 0
      const skip = 0
  ...
  describe('read', () => {
    it('should return the data successfully', async () => {
      const expectedResult: <%= classify(name) %> = object
  ...
  describe('create', () => {
    it('should return a <%= classify(name) %> object', async () => {
      const dto: <%= classify(name) %>Dto = { someProp: 'value' }
